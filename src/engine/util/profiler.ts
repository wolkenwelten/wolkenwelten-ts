 ...
 *
 * Contains a simple built-in profiler that is always running, mainly to get an overall
 * picture, especially on platforms where the browser doesn't provide a satisfying profiler.
 */
